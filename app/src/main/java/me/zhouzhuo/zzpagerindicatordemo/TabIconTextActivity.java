 ...
 */
public class TabIconTextActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tab_with_icon_and_text);

        ZzPagerIndicator indicator = (ZzPagerIndicator) findViewById(R.id.indicator);
        ZzPagerIndicator indicatorExpand = (ZzPagerIndicator) findViewById(R.id.indicator_expand);
        ZzPagerIndicator indicatorLong = (ZzPagerIndicator) findViewById(R.id.indicator_long);
        ZzPagerIndicator indicatorNoLine = (ZzPagerIndicator) findViewById(R.id.indicator_no_underline);
        ...
        indicatorExpand.setViewPager(viewPager);
        indicatorLong.setViewPager(viewPager);
        indicatorNoLine.setViewPager(viewPager);
